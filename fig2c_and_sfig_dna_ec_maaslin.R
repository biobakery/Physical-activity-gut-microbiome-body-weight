##############################################################################################################################################
# 1) Purposes: conduct MaAsLin regression to calculate the associations of the measures of physical activity and adiposity with abundances of microbial EC enzymes, and create heatmap
...
# combine DNA enzyme datasets to 1 data table
...
rownames(dna.ec.qc)[which(rownames(dna.ec.qc)=="70324089_SF07")]<-"70324089_SF05"
rownames(dna.ec.qc)[which(rownames(dna.ec.qc)=="70324089_SF08")]<-"70324089_SF06"
...
rownames(id_913)<-id_913$id
dna.ec.qc$id<-rownames(dna.ec.qc)
dna.ec.qc<-inner_join(dna.ec.qc, id_913, by="id")
rownames(dna.ec.qc)<-dna.ec.qc$id
dna.ec.qc<-subset(dna.ec.qc, select = -id)
...
maaslin_diet<-function(dir, exposure){
  Maaslin2(dna.ec.qc, 
           ...
           fixed_effects = c(exposure,"age_fecal","calor122cn","probio_2mo_qu","stool_type", "smk", "ant_12mo_qu"))
}
maaslin_diet(dir="./data_generated/maaslin_results/paee_pam_ec_dna",  exposure = "paee_pam")
maaslin_diet(dir="./data_generated/maaslin_results/mets_vigpam_ec_dna",  exposure = "mets_vigpam")
maaslin_diet(dir="./data_generated/maaslin_results/mets_modpam_ec_dna",  exposure = "mets_modpam")
maaslin_diet(dir="./data_generated/maaslin_results/mets_ltpam_ec_dna",  exposure = "mets_ltpam")
maaslin_diet(dir="./data_generated/maaslin_results/act_paqlong_ec_dna",  exposure = "act_paqlong")
maaslin_diet(dir="./data_generated/maaslin_results/vpa_paqlong_ec_dna",  exposure = "vpa_paqlong")
maaslin_diet(dir="./data_generated/maaslin_results/mpa_paqlong_ec_dna",  exposure = "mpa_paqlong")
maaslin_diet(dir="./data_generated/maaslin_results/lpa_paqlong_ec_dna",  exposure = "lpa_paqlong")
maaslin_diet(dir="./data_generated/maaslin_results/bmi_dlw_ec_dna",  exposure = "bmi_dlw")
maaslin_diet(dir="./data_generated/maaslin_results/pfat_dlw_ec_dna",  exposure = "pfat_dlw")
maaslin_diet(dir="./data_generated/maaslin_results/weightchg_blood_ec_dna",  exposure = "weightchg_blood")
maaslin_diet(dir="./data_generated/maaslin_results/wtchgsto21_ec_dna",  exposure = "wtchgsto21")
maaslin_diet(dir="./data_generated/maaslin_results/lgcrp_ec_dna",  exposure = "lgcrp")
maaslin_diet(dir="./data_generated/maaslin_results/lghba1c_ec_dna",  exposure = "lghba1c")
...
sigpaee_pam <- sig_results(dir="./data_generated/maaslin_results/paee_pam_ec_dna/significant_results.tsv",  exposure = "paee_pam")
sigmets_vigpam <- sig_results(dir="./data_generated/maaslin_results/mets_vigpam_ec_dna/significant_results.tsv",  exposure = "mets_vigpam")
sigmets_modpam <- sig_results(dir="./data_generated/maaslin_results/mets_modpam_ec_dna/significant_results.tsv",  exposure = "mets_modpam")
sigmets_ltpam <- sig_results(dir="./data_generated/maaslin_results/mets_ltpam_ec_dna/significant_results.tsv",  exposure = "mets_ltpam")
sigact_paqlong <- sig_results(dir="./data_generated/maaslin_results/act_paqlong_ec_dna/significant_results.tsv",  exposure = "act_paqlong")
sigvpa_paqlong <- sig_results(dir="./data_generated/maaslin_results/vpa_paqlong_ec_dna/significant_results.tsv",  exposure = "vpa_paqlong")
sigmpa_paqlong <- sig_results(dir="./data_generated/maaslin_results/mpa_paqlong_ec_dna/significant_results.tsv",  exposure = "mpa_paqlong")
siglpa_paqlong <- sig_results(dir="./data_generated/maaslin_results/lpa_paqlong_ec_dna/significant_results.tsv",  exposure = "lpa_paqlong")
sigbmi_dlw <- sig_results(dir="./data_generated/maaslin_results/bmi_dlw_ec_dna/significant_results.tsv",  exposure = "bmi_dlw")
sigpfat_dlw <- sig_results(dir="./data_generated/maaslin_results/pfat_dlw_ec_dna/significant_results.tsv",  exposure = "pfat_dlw")
sigweightchg_blood <- sig_results(dir="./data_generated/maaslin_results/weightchg_blood_ec_dna/significant_results.tsv",  exposure = "weightchg_blood")
sigwtchgsto21 <- sig_results(dir="./data_generated/maaslin_results/wtchgsto21_ec_dna/significant_results.tsv",  exposure = "wtchgsto21")
siglgcrp <- sig_results(dir="./data_generated/maaslin_results/lgcrp_ec_dna/significant_results.tsv",  exposure = "lgcrp")
siglghba1c <- sig_results(dir="./data_generated/maaslin_results/lghba1c_ec_dna/significant_results.tsv",  exposure = "lghba1c")
...
sigpaee_pamall <- all_results(dir="./data_generated/maaslin_results/paee_pam_ec_dna/all_results.tsv",  exposure = "paee_pam", label="Recent total PA")
sigmets_vigpamall <- all_results(dir="./data_generated/maaslin_results/mets_vigpam_ec_dna/all_results.tsv",  exposure = "mets_vigpam", label="Recent vigorous PA")
sigmets_modpamall <- all_results(dir="./data_generated/maaslin_results/mets_modpam_ec_dna/all_results.tsv",  exposure = "mets_modpam", label="Recent moderate PA")
sigmets_ltpamall <- all_results(dir="./data_generated/maaslin_results/mets_ltpam_ec_dna/all_results.tsv",  exposure = "mets_ltpam", label="Recent light PA")
sigact_paqlongall <- all_results(dir="./data_generated/maaslin_results/act_paqlong_ec_dna/all_results.tsv",     exposure = "act_paqlong", label="Long-term total PA")
sigvpa_paqlongall <- all_results(dir="./data_generated/maaslin_results/vpa_paqlong_ec_dna/all_results.tsv",   exposure = "vpa_paqlong", label="Long-term vigorous PA")
sigmpa_paqlongall <- all_results(dir="./data_generated/maaslin_results/mpa_paqlong_ec_dna/all_results.tsv",   exposure = "mpa_paqlong", label="Long-term moderate PA")
siglpa_paqlongall <- all_results(dir="./data_generated/maaslin_results/lpa_paqlong_ec_dna/all_results.tsv",   exposure = "lpa_paqlong", label="Long-term light PA")
sigbmi_dlwall <- all_results(dir="./data_generated/maaslin_results/bmi_dlw_ec_dna/all_results.tsv",  exposure = "bmi_dlw", label="BMI at stool collection")
sigpfat_dlwall <- all_results(dir="./data_generated/maaslin_results/pfat_dlw_ec_dna/all_results.tsv",    exposure = "pfat_dlw", label="Fat mass % at stool collection")
sigweightchg_bloodall <- all_results(dir="./data_generated/maaslin_results/weightchg_blood_ec_dna/all_results.tsv",    exposure = "weightchg_blood", label="6-month weight change between the 2 stool collections")
sigwtchgsto21all <- all_results(dir="./data_generated/maaslin_results/wtchgsto21_ec_dna/all_results.tsv",    exposure = "wtchgsto21", label="Weight change from age 21 to stool collection")
siglgcrpall <- all_results(dir="./data_generated/maaslin_results/lgcrp_ec_dna/all_results.tsv",    exposure = "lgcrp", label="CRP at stool collection")
siglghba1call <- all_results(dir="./data_generated/maaslin_results/lghba1c_ec_dna/all_results.tsv",    exposure = "lghba1c", label="HbA1c at stool collection")
...
join12<-full_join(join10, siglgcrp, by="feature")
join13<-full_join(join10, siglghba1c, by="feature")
...
write.csv(bind9_label, file="./data_generated/fig4b_maaslin.csv")

# create heatmap for PA-dna ec associations
...
level_y_order <- factor(bind9_label$ec_name, levels = ec_label$ec_name)
...
p1<-ggplot(bind9_label, aes(level_x_order, level_y_order)) +
  ...
  theme(legend.title = element_text(size = 40),
        ...
        axis.text.x = element_text(angle = 45, hjust = 1, size=40,color="black")) +
  labs(fill = "Beta coefficient")
png(file="./figure_generated/sfig_heatmap_maaslin_dna_ec.png",width=3500,height=5000, pointsize=40)
print(p1)
dev.off()

# only keep EC for creating figure 2
...
bind9display<-subset(bind9_label, 
                       ec_name=="EC 2.6.1.42: branched-chain-amino-acid transaminase"|
                       ec_name=="EC 3.1.3.5: 5'-nucleotidase" |
                       ec_name=="EC 3.5.4.10: Imp cyclohydrolase"|
                       ec_name=="EC 2.4.1.18: 1,4-alpha-glucan branching enzyme" | 
                       ec_name=="EC 2.4.1.1: glycogen phosphorylase"|
                       ec_name=="EC 3.2.1.78: mannan endo-1,4-beta-mannosidase" )
...
level_y_order <- factor(bind9display$ec_name, levels =c( "EC 3.2.1.78: mannan endo-1,4-beta-mannosidase",
                                                         "EC 2.4.1.1: glycogen phosphorylase",
                                                         "EC 2.4.1.18: 1,4-alpha-glucan branching enzyme",
...
p2<-ggplot(bind9display, aes(level_x_order, level_y_order)) +
  ...
  labs(fill = "Beta coefficient")
png(file="./figure_generated/a.fig2c_dna_ec.png",width=3000,height=1400, pointsize=50)
print(p2)
dev.off()
